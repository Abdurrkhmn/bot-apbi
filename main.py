...
# --- KONFIGURASI DATA ---
TOKEN_TELEGRAM = '8613320694:AAGt5OXlwu632uLM-wjcOoT-DI8-hAPYL60'
API_KEY_GEMINI = 'AIzaSyCois6xAZxXhS7pcLVO4iZ_Qm-OHfdRFEY'
...
# SOLUSI ERROR 404: Menggunakan model 'gemini-1.5-flash' tanpa prefix 'models/' 
# karena beberapa versi library otomatis menambahkannya.
try:
...
def handle_all(message):
    ...
    # 1. CEK LIMIT (BISNIS PLAN: PEMBATASAN AKSES)
    ...
    # 2. CARI DI GOOGLE SHEETS (PERANTARA DATA)
    ...
    # 3. JIKA TIDAK ADA DI SHEETS, TANYA AI STUDIO
    if not found:
        try:
    ...
    # 4. CTA MENTORING (BISNIS PLAN: KONVERSI)
    markup = types.InlineKeyboardMarkup()
